...
# settings.database.database = "issaav"
settings.database.database = "issaav"
...
settings.mail.server = "mail.interlink.mr:587"
...
settings.gis.api_google = "AIzaSyDjMiU6C-04f0JGfKZdYt82-LPdRx1BIg0"
# OpenWeatherMap API Key (for OpenWeatherMap Layers)
settings.gis.api_openweathermap = "081ae380a293602b3ababa3951a48a1c"
