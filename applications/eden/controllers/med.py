        ...
        if r.interactive:
            if r.component:
                ...
                table.total_beds.comment = DIV(_class = "tooltip",
                                               _title = "%s|%s" % (T("Nombre total de lits"),
                                                                   T("Nombre total de lits dans cet établissement. Mise à jour automatique à partir de rapports quotidiens."),
                                                                   ),
                                               )
                table.available_beds.comment = DIV(_class = "tooltip",
                                                   _title = "%s|%s" % (T("Lits disponibles"),
                                                                       T("Nombre de lits vacants/disponibles dans cet établissement. Automatiquement mis à jour à partir de rapports quotidiens."),
                                                                       ),
                                                   )
